...
# [Undergraduate](./scholarship/1_ug)
...
For more details, see the [UG Guide](./scholarship/1_ug)

# [Special Training College](./scholarship/2_stc)
...
For more details, see the [STC Guide](./scholarship/2_stc).

# [College of Technology](./scholarship/3_cot)
Excruciatingly similar to that of Undergraduate, but the exams are different. If you want to contribute, please send a draft containing the steps necessary to apply for this scholarship on the Discord server.

For more details, see the [CoT Guide](./scholarship/3_cot).

# [Research](./scholarship/4_pg)
...
For more details, see the [PG Guide](./scholarship/4_pg).

# [School Professor Training](./scholarship/5_spt)
...
For more details, see the [SPT Guide](./scholarship/5_spt).

# [Culture and Japanese Language](./scholarship/6_cjl)
No direct sources provided. Check your embassy or consulate website for more information. If you want to contribute, please send a draft containing the steps necessary to apply for this scholarship. Try to follow the pattern above.

For more details, see the [CJL Guide](./scholarship/6_cjl).