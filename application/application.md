...
# [Undergraduate]({% link application/1_ug.md %})
...
For more details, see the [UG Guidelines]({% link application/1_ug.md %}).

# [Special Training College]({% link application/2_stc.md %})
...
For more details, see the [STC Guidelines]({% link application/2_stc.md %}).
...
For more details, see the [CoT Guidelines]({% link application/3_cot.md %}).

# [Research]({% link application/4_pg.md %})
...
For more details, see the [PG Guidelines]({% link application/4_pg.md %}).

# [School Professor Training]({% link application/5_spt.md %})
...
For more details, see the [SPT Guidelines]({% link application/5_spt.md %}).

# [Culture and Japanese Language]({% link application/6_cjl.md %})
No direct sources provided. Check your embassy or consulate website for more information. If you want to contribute, please send a draft containing the steps necessary to apply for this scholarship on ⁠suggestions. Try to follow the pattern above.

For more details, see the [CJL Guidelines]({% link application/6_cjl.md %}).
